...
/** End-to-end form validation: `Field.mapValidated` runs on submit, an invalid input surfaces its validation error in
  * the rendered UI, and a corrected form assembles the case class.
  */
