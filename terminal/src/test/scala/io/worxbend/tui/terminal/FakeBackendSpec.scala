...
/** Proves the `Backend` trait has no JLine leakage: this file implements a complete fake backend without
  * importing a single JLine type (PLAN.md §11, step 3 acceptance criterion).
  */
