...
object ColorDepth:
  ...
  /** Conventional environment-based detection: `COLORTERM=truecolor|24bit` wins, a `256color` TERM falls back
    * to the 256 palette, everything else to the classic 16.
    */
